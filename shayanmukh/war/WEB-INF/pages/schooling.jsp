...
<a href="/"><img style="border: 0px solid ; width: 75px; height: 75px;"  src='<spring:message code="prop.img.home.button"/>'/></a>
	<center><h2><spring:message code="prop.shayanmukh.schooling.heading.text"/></h2></center>
	<table>
		...
		<tr>
			...
			<td>
				<font color="orange">
					<p>
						<spring:message code="prop.shayanmukh.schooling.para1.text"/>
					</p>
				</font>
			</td>
		</tr>
					...
					<script>
	    	  		...
	    	  		Galleria.run('#galleria', {
			              picasa: 'useralbum:shayan.mukh/School_1stDay'
			          }); 
	    	  	</script>
</body>
</html>