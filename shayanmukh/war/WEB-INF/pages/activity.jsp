...
<head>
	...
	<body bgcolor="#000">
		...
		<center><h2><spring:message code="prop.shayanmukh.activity.heading.text"/></h2></center>
			<table>
		...
		<tr>
			...
			<td>
				<font color="orange">
					<p>
						<spring:message code="prop.shayanmukh.moments.para1.text"/>
					</p>
					<p>
						<spring:message code="prop.shayanmukh.moments.para2.text"/>
					</p>
					<p align="center">
						<img alt="" src='<spring:message code="prop.img.kid.shoe"/>'>
					</p>
				</font>
			</td>
		</tr>
			...
			<td align="right">
					...
					<script>
	    	  		...
	    	  		Galleria.run('#galleria', {
			              picasa: 'useralbum:shayan.mukh/ChildHood_Moments'
			          }); 
	    	  	</script>
	</body>
</html>